...
//             Cost of Goods Sold (COGS)
//           </h2>
//           <p className="text-lg font-bold">{`$${data.costOfGoodsSold[data.costOfGoodsSold.length - 1]}`}</p>
//           <p className="text-sm text-gray-500">Total COGS for the selected range</p>
//         </div>
//       </div>
...
//           <Bar data={costOfGoodsSoldData} options={{
//             responsive: true,
//             plugins: {
//               tooltip: {
//                 callbacks: {
...
//         <h2 className="text-xl font-semibold mb-4">Download Reports</h2>
//         <div className="flex justify-between items-center">
//           <p className="text-lg text-gray-500">Generate a full report based on the selected data range.</p>
//           <button className="bg-blue-500 text-white px-4 py-2 rounded-md flex items-center">
//             <FaDownload className="mr-2" />
//             Download Report
//           </button>
...
//     },
//     investment: {
//       "Last 6 months": [1000, 1200, 1300, 1800, 1600, 2000],
//       "Last 1 year": [1200, 1400, 1500, 1800, 1700, 2000, 2100, 2200, 2300, 2400, 2500, 2700],
//       "Last 3 years": [1100, 1300, 1500, 2000, 2500, 3000, 3200, 3400, 3600, 3800, 3900, 4000, 4200, 4400, 4600],
//     },
//     farmEquipment: [
//       "Tractor",
//       "Plow",
...
//   // Dynamically change the data based on selected date range
//   const updateData = (range) => {
//     const revenue = reportData.revenue[range];
//     const investment = reportData.investment[range];
//     const profit = revenue.map((value, index) => value - investment[index]);
//     return {
//       revenue,
//       investment,
//       profit,
...
//             Investment
//           </h2>
//           <p className="text-lg font-bold">{`$${data.investment[data.investment.length - 1]}`}</p>
//           <p className="text-sm text-gray-500">Investment for the selected range</p>
//         </div>
...
//             Profit
//           </h2>
//           <p className="text-lg font-bold">{`$${data.profit[data.profit.length - 1]}`}</p>
//           <p className="text-sm text-gray-500">Profit for the selected range</p>
//         </div>
//       </div>

//       {/* Revenue Analysis Graph */}
//       <div className="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition-all mb-6">
//         <h2 className="text-xl font-semibold mb-4">Revenue, Investment & Profit Analysis</h2>
//         <Line data={revenueData} options={{
//           responsive: true,
//           plugins: {
//             tooltip: {
...
//       {/* Farm Equipment List */}
//       <div className="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition-all mb-6">
//         <h2 className="text-xl font-semibold mb-4">Farm Equipment</h2>
//         <ul className="list-disc pl-6">
//           {reportData.farmEquipment.map((equipment, index) => (
...
const AnalyticsAndReports = () => {
  ...
  const [reportData, setReportData] = useState({
    ...
    farmEquipmentUsage: {
      "Last 6 months": [
        { equipment: "Tractor", used: "Jan, Mar, Jun" },
        { equipment: "Plow", used: "Feb, Apr, May" },
        { equipment: "Harvester", used: "Apr, Jun" },
      ],
      "Last 1 year": [
        { equipment: "Tractor", used: "Jan, Mar, Apr, May, Nov" },
        { equipment: "Plow", used: "Feb, Jun, Sep, Oct" },
        { equipment: "Harvester", used: "Mar, Jun, Oct" },
      ],
      "Last 3 years": [
        { equipment: "Tractor", used: "Jan, Mar, Apr, May, Jul, Aug" },
        { equipment: "Plow", used: "Feb, Jun, Sep, Oct" },
        { equipment: "Harvester", used: "Mar, Apr, Jul, Oct" },
      ],
    },
  });
