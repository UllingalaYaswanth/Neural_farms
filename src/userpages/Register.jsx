...
//     try {
//       const response = await fetch('https://your-backend-endpoint.com/api/farmers', {
//         method: 'POST',
//         headers: {
...
//         <h2 className="text-2xl font-semibold text-center text-gray-800 mb-6">Farmer Registration</h2>

//         <form onSubmit={handleSubmit} className="space-y-2">
//           {errorMessage && <div className="text-red-500 text-sm mb-4">{errorMessage}</div>}

//           <div className="flex flex-col space-y-2">
//             <label className="text-sm font-semibold">Farmer ID:</label>
//             <input
//               type="text"
//               value={farmerID}
...
//           <div className="flex flex-col space-y-2">
//             <label className="text-sm font-semibold">Land No:</label>
//             <input
//               type="text"
//               value={landNo}
...
//     "Soil Testing", "Drone Service", "Irrigation Services", "Pest and Disease Monitoring",
//     "Fertilization Services", "Harvest Planning & Equipment Rental", "Crop Health Monitoring",
//     "Weed Control", "Crop Rotation Planning", "Harvest Storage & Handling", "Market Access & Sales Support",
//     "Precision Agriculture", "Climate and Weather Advisory", "Post-Harvest Processing"
//   ];
