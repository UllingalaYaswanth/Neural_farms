...
//       <h1 className="text-3xl font-semibold mb-6 text-center">Weather & Climate</h1>

//       {/* Current Weather */}
//       <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
//         <h2 className="text-xl font-semibold mb-4 flex items-center">
//           <WiDaySunny className="mr-2 text-3xl text-yellow-500" />
//           Current Weather
//         </h2>
...
//         <p className="text-sm text-gray-500">Wind: {weatherData.windSpeed} km/h {weatherData.windDirection}</p>
//         <p className="text-sm text-gray-500">Air Quality Index (AQI): {weatherData.airQuality}</p>
//       </div>

//       {/* 5-Day Forecast */}
//       <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
//         <h2 className="text-xl font-semibold mb-4 flex items-center">
//           <WiRain className="mr-2 text-3xl text-blue-500" />
//           5-Day Forecast
//         </h2>
...
//       <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
//         <h2 className="text-xl font-semibold mb-4 flex items-center">
//           <WiWindy className="mr-2 text-3xl text-green-500" />
//           Temperature Over Time
//         </h2>
...
//       <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
//         <h2 className="text-xl font-semibold mb-4 flex items-center">
//           <WiWindy className="mr-2 text-3xl text-gray-500" />
//           Wind Speed & Direction
//         </h2>
//         <p className="text-lg">{weatherData.windSpeed} km/h</p>
//         <p className="text-sm text-gray-500">Direction: {weatherData.windDirection}</p>
//       </div>

//       {/* Air Quality Index */}
//       <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
//         <h2 className="text-xl font-semibold mb-4 flex items-center">
//           <MdAir className="mr-2 text-3xl text-indigo-500" />
//           Air Quality Index (AQI)
//         </h2>
//         <p className="text-lg">{weatherData.airQuality}</p>
