...
const RegisterPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-green-500 to-green-700">
       <a href='https://www.mbs.investments/' target='blank'><img src={mbsg} alt="logo" className="absolute w-80 h-auto top-12 left-40" /></a>
       <a href='https://www.mbstech.ai/' target='blank'><img src={mbstechai} alt="logo" className="absolute w-60 h-auto top-16 right-40" /></a>
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
